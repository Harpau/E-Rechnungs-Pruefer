    ...
    if type_resolution.status is DocumentTypeStatus.UNKNOWN:
        ...
        findings.append(
            _finding(
                ...
                "Der Rechnungsartcode gehört nicht zur mit CEN EN 16931 1.3.16 gebündelten UNTDID-1001-Auswahl.",
        ...
        findings.append(
            _finding(
                ...
                f"Der Rechnungsartcode ist gemäß CEN EN 16931 1.3.16 nicht für {root_label} vorgesehen.",
                location=location_label,
                actual=type_code,
